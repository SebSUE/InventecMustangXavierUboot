...
#define IPROC_GPIO_REG_BASE				(ChipcommonG_GP_DATA_IN)
#define IPROC_PWMCTL					(ChipcommonG_PWMCTL)
#define IPROC_MII_Management_Control	(ChipcommonG_MII_Management_Control )
...
#define IPROC_RNG_REG_BASE		(ChipcommonS_RNG_CTRL)
#define IPROC_TIM0_REG_BASE		(ChipcommonG_tim0_TIM_TIMER1Load)
#define IPROC_TIM1_REG_BASE		(ChipcommonG_tim1_TIM_TIMER1Load)
#define IPROC_SRAU_REG_BASE		(0x18007000)
#define IPROC_UART0_REG_BASE	(ChipcommonG_UART0_UART_RBR_THR_DLL)
