...
int board_init(void)
{
	...
	/* Address of boot parameters passing to kernel
...
int misc_init_r(void)
{
	 ...
	 * The timeout value used here is 0.9s
	 */
...
int board_mmc_init(bd_t *bis)
{
	...
	/* Register eMMC - SDIO2 */
	ret = kona_sdhci_init(1, CONFIG_SYS_SDIO1_MIN_CLK, 0);
	if (ret)
		return ret;

	/* Register SD Card - SDIO4 kona_mmc_init assumes 0 based index */
	ret = kona_sdhci_init(3, CONFIG_SYS_SDIO3_MIN_CLK, 0);
	return ret;
}
#endif
