...
/* Version of hwalk_r with callback context. */
int hwalk_ctx_r(struct hsearch_data *__htab, void *context,
		int (*callback)(void *context, ENTRY *));
...
#define H_PRNT_READABLY	(1 << 9) /* print readably */
